...
trap_density_image_py = np.array([0.003, 0.003, 0.003, 0.003, 0.003])*10
trap_density_serial_py = np.array([0.01, 0.01, 0.01, 0.01, 0.01])*10
...
gpyhdu.header.set('FILENAME', 'sxi_gain_v6.fits', 'File Name')
...
gnyhdu.header.set('VERSION', 'v6', 'Extension version number')
gnyhdu.header.set('FILENAME', 'sxi_gain_v6.fits', 'File Name')
...
fitsobj.writeto('sxi_gain_v6.fits')
