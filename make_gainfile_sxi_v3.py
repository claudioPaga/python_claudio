...
gnyhdu.header.set('VERSION', 'v1', 'Extension version number')
gnyhdu.header.set('FILENAME', 'sxi_gain_v3.fits', 'File Name')
...
fitsobj.writeto('sxi_gain_v3.fits')
